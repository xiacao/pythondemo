#用来创建excel文档并写入数据
###
#源码地址：http://blog.csdn.net/u010187278/article/details/77847737?locationNum=10&fps=1
#
#
#阿
###
...
mes = input("请输入需要爬取的岗位关键词：")
#获取原码
def get_content(page):

    url ='http://search.51job.com/list/000000,000000,0000,00,9,99,'+mes+',2,'+ str(page)+'.html'
    print(url)
...
newTable="D:\python\myspoils\zhilian\智联招聘岗位爬虫结果.xls"#表格名称
